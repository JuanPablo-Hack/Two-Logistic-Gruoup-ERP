            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Area Comercial /</span> Lista de contratos</h4>
                        <!-- Bordered Table -->
                        <div class="card">
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="javascript:void(0);" onclick="eliminarContrato(<?php echo $mostrar['id'] ?>)"><i class="bx bx-trash me-1"></i> Eliminar</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
