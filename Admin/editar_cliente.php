...
<head>
    ...
    $row = mysqli_fetch_array(cliente($_GET['id']));
    ?>
</head>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Area Comercial/</span> Editar Clientes</h4>
                                ...
                                <div class="col-xl">
                                    <div class="card mb-12">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">Editar de cliente</h5>
                                        </div>
                                        <div class="card-body">
