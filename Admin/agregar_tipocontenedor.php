...
<body>
                                ...
                                <div class="col-xl">
                                    <div class="card mb-12">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">Alta de tipo de contenedor</h5>
                                        </div>
                                        <div class="card-body">
                                            <form id="Altatipocontenedor">
                                                <div class="mb-3">
                                                ...
                                                <button type="submit" class="btn btn-primary">Agregar tipo de contenedor</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document
                .getElementById("Altatipocontenedor")
                .addEventListener("submit", Altatipocontenedor);
        });
        async function Altatipocontenedor(e) {
            e.preventDefault();
            console.log("Altatipocontenedor");
            var form = document.getElementById("Altatipocontenedor");
