...
<head>
    ...
    $row = mysqli_fetch_array(traspaleo($_GET['id']));
    $clientes = clientes();
...
<body>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Area Operativa/</span>Editar de Traspaleo</h4>
                                ...
                                <div class="col-xl">
                                    <div class="card mb-12">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">Editar de Traspaleo</h5>
                                        </div>
                                        <div class="card-body">
                                            <form id="EditarTraspaleo">
                                                <div class="mb-3">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document
                .getElementById("EditarTraspaleo")
                .addEventListener("submit", EditarTraspaleo);
        });
        async function EditarTraspaleo(e) {
            e.preventDefault();
            var form = document.getElementById("EditarTraspaleo");
