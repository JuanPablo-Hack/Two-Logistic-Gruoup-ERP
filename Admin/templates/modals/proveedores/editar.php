<!-- TODO: Terminar la zona de edición de los proveedores -->
<div class="modal fade" id="EditarProveedor<?php echo $mostrar['id'] ?>" tabindex="-1" aria-hidden="true">
    <?php
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel3">Editar Proveedor</h5>
