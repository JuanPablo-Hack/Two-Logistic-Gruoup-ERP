                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" onclick="eliminarAgenciaAduanal(<?php echo $mostrar['id'] ?>)" class="btn btn-sm btn-icon item-edit" title="Eliminar"><i class='bx bx-x-circle'></i></button>
                                </td>
                            </tr>
