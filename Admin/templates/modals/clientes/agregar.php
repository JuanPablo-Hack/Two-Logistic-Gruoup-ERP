                ...
                <form id="AltaCliente">
                    ...
                    <div class="row g-2">
                        <div class="col mb-0">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="number" min="0" id="basic-icon-default-company" class="form-control" min="0" name="credito" />
                            </div>
                        </div>
                        <div class="col mb-0">
                            <label class="form-label" for="basic-icon-default-company">Días de almacenamiento</label>
                            <div class="input-group input-group-merge">
                                <input type="number" min="0" id="basic-icon-default-company" class="form-control" min="0" name="almacenamiento" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
