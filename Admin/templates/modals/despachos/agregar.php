    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-success" role="alert" style="display:none;" id="success">Despacho Aduanal
                ...
                <form id="AltaDespacho">
                    <div class="row g-3">
                        <div class="col mb-0">
                            ...
                            <select class="form-select" id="num_conceptos" aria-label="Default select example" required
                                name='tipo_oper'>
                    ...
                    <div class="row g-2">
                        <div class="col mb-0">
                            ...
                            <select class="form-select" id="num_conceptos" aria-label="Default select example"
                                name="mercancia" required>
