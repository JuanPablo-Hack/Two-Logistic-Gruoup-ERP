...
<body>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Variables de Sistema/</span> Agregar Tipo de Embalaje</h4>
                                ...
                                <div class="col-xl">
                                    <div class="card mb-12">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">Alta de tipo de embalaje</h5>
                                        </div>
                                        <div class="card-body">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document
                .getElementById("AltaTipoEmbalaje")
                .addEventListener("submit", AltaTipoEmbalaje);
        });
        async function AltaTipoEmbalaje(e) {
            e.preventDefault();
            console.log("Altatipocontenedor");
            var form = document.getElementById("AltaTipoEmbalaje");
            ...
            swalWithBootstrapButtons
                .fire({
                    ...
                    confirmButtonText: "Si, agregar tipo de embalaje",
                            ...
                            .then((result) => {
                                if (result == 1) {
                                    swalWithBootstrapButtons.fire(
                                        "Agregado!",
                                        "El tipo de embalaje ha sido agregado en la base de datos.",
                                        "success"
                                    );
                                    form.reset();
                                    setTimeout(function() {
