...
<body>
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item active">
                                <a href="salida_producto.php" class="menu-link">
                                    <div data-i18n="Text Divider">Salidas de Productos</div>
                                </a>
                            </li>
                            <li class="menu-item">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Area Operativa /</span> Salidas de Productos</h4>
                        <?php include 'templates/modals/inventario/listar_salidas_productos.php'; ?>
                    </div>
    ...
    <script src="js/salidas_productos.js"></script>
</body>
