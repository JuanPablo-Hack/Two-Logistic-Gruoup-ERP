...
<head>
    ...
    $row = mysqli_fetch_array(exportacion($_GET['id']));
    $clientes = clientes();
...
<body>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Area Operativa/</span> Editar Exportaciones</h4>
                                ...
                                <div class="col-xl">
                                    <div class="card mb-12">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">Editar de Exportación</h5>
                                        </div>
                                        <div class="card-body">
                                            <form id="EditarExportaciones" enctype="multipart/form-data">
                                                ...
                                                <br>
                                                <button type="submit" class="btn btn-primary">Editar Exportación</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document
                .getElementById("EditarExportaciones")
                .addEventListener("submit", EditarExportaciones);
        });
        async function EditarExportaciones(e) {
            e.preventDefault();
            var form = document.getElementById("EditarExportaciones");
            ...
            swalWithBootstrapButtons
                .fire({
                    ...
                    confirmButtonText: "Si, editar exportación",
                            ...
                            .then((result) => {
                                if (result == 1) {
                                    swalWithBootstrapButtons.fire(
                                        "Actualizado!",
                                        "La exportación ha sido actualizado en la base de datos.",
                                        "success"
                                    );
                                    form.reset();
                                    setTimeout(function() {
