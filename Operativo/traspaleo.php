                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $mostrar['nombre_operador']; ?></td>
                                                    <td><?php echo $mostrar['placas']; ?></td>
                                                    <td><?php echo $mostrar['no_remolque']; ?></td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a href="editar_traspaleo.php?id=<?php echo $mostrar['id'] ?>" class="dropdown-item" href="javascript:void(0);"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                                <a class="dropdown-item" href="javascript:void(0);" onclick="eliminartraspaleo(<?php echo $mostrar['id'] ?>)"><i class="bx bx-trash me-1"></i> Delete</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
