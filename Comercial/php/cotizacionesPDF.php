                ...
                <div class="tm_invoice_in">
                    ...
                    <div class="tm_invoice_info tm_mb25">
                        <div class="tm_invoice_info_list tm_white_color">
                            <p class="tm_invoice_number tm_m0">Cotización No: <b>COT-<?php date('Y') . '-' . $id ?></b>
                            </p>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="unit">
                                                <?php echo '$' . number_format($DatosTipoServicio['precio'], 2, '.', ',') ?>
                                            </td>
                                            <td class="qty"><?php echo $cantidades[$i] ?></td>
                                            <td class="total">
                                                <?php echo '$' . number_format($cantidades[$i] * $DatosTipoServicio['precio'], 2, '.', ',') ?>
                                            </td>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="tm_gray_bg">
                                            ...
                                            <td class="tm_width_3 tm_primary_color tm_text_right">
                                                +$<?php echo number_format($iva, 2, '.', ',') ?></td>
                                        </tr>
                                        <tr class="tm_accent_bg">
