...
<head>
    ...
    <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=jZWIEGLtPmU6ciCDyqUCB2djJafpR6bhhsBN9_Wp7qXEnNiG8M6uOzg7uOK_aA9V8AZa6dGRQh0db0uoIrMPRg" charset="UTF-8"></script>
</head>
                ...
                <div class="tm_invoice_in">
                    ...
                    <div class="tm_invoice_info tm_mb25">
                        <div class="tm_invoice_info_list tm_white_color">
                            <p class="tm_invoice_number tm_m0">Cotización No: <b>COT-<?php date('Y') . '-' . $id ?></b></p>
                            <p class="tm_invoice_date tm_m0">Fecha: <b><?php echo $datos_cotizacion['creado'] ?></b></p>
                        </div>
                    ...
                    <div class="tm_invoice_head tm_mb10">
                        <div class="tm_invoice_left">
                            ...
                            <p>
                                <?php echo $datos_cliente['razon_social'] ?> <br><?php echo $datos_cliente['rfc'] ?>
                                <?php echo $datos_comercial[0] ?> <br><?php echo $datos_comercial[1] ?> <br>
                                <?php echo $datos_comercial[2] ?>
                            </p>
                        </div>
                                ...
                                <table class="tm_mb15">
                                    <tbody>
                                        <tr class="tm_gray_bg ">
                                            ...
                                            <td class="tm_width_3 tm_primary_color tm_bold tm_text_right">$<?php echo number_format($subtotal, 2, '.', ',') ?></td>
                                        </tr>
                                        <tr class="tm_gray_bg">
                                            <td class="tm_width_3 tm_primary_color">I.V.A <span class="tm_ternary_color">(16%)</span></td>
                                            <td class="tm_width_3 tm_primary_color tm_text_right">+$<?php echo number_format($iva, 2, '.', ',') ?></td>
                                        </tr>
                                        <tr class="tm_accent_bg">
                    ...
                    <div class="tm_note tm_text_center tm_font_style_normal">
                        ...
                        <p class="tm_m0"> Es importante mencionar que las tarifas ofertadas no incluyen
                            ...
                            contenedor ni tampoco gastos adicionales ajenos a la operación. <br>El pago de impuestos que cause la mercancía en origen y/o en destino será siempre por cuenta del embarcador y/o consignatario. <br> En caso de ser mercancía IMO, estará sujeto a la aprobación de la
